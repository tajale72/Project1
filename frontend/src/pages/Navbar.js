...
function Navbar() {
  return (
    <>
        ...
        <Link to={"/aboutus"} className="hover:bg-teal-600 hover:border-2 hover:border-white hover:text-teal-200 hover:shadow-md rounded-lg bg-white text-black">About Us</Link>
